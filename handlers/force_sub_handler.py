    ...
    try:
        ...
        if user.status == "kicked":
            await bot.send_message(
                ...
                text="Sorry Sir, You are Banned to use me.[contact my owner for any help](https://t.me/jack_sparow119).",
                parse_mode="markdown",
        ...
        await bot.send_message(
            chat_id=cmd.from_user.id,
            text="Something went Wrong. [contact my owner for any help](https://t.me/jack_sparow119).",
            parse_mode="markdown",
            disable_web_page_preview=True
        )
        return 200
